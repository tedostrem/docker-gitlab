...
postgresql['shared_buffers'] = '1MB' # Prevent Postgres from trying to allocate 25% of total memory


## Advanced settings
# postgresql['ha'] = false
# postgresql['dir'] = "/var/opt/gitlab/postgresql"
postgresql['log_directory'] = '/var/log/gitlab/postgresql' # Configure GitLab to redirect PostgreSQL logs to the data volume
